...
public class M2S extends AppCompatActivity {
    ...
    private String mod = "m2s", lay = "json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("手机查微博");
        initView();
    }
    @Override
    ...
    private void initView() {
        M_input = findViewById(R.id.m2s_code_input);
        M_msg_output = findViewById(R.id.m2s_msg_output);
    }

    public void inquireM2S(View view) {
        M_Code = M_input.getText().toString();
        if(M_Code.length() == 0) {
            Toast.makeText(M2S.this, "请输入手机号码", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(M2S.this, "查询中...", Toast.LENGTH_SHORT).show();
...
//            Log.d("tag" , "q2m" + uin);
    ...
    public void copyMsg(View view) {
        ...
        Toast.makeText(M2S.this, "已复制到粘贴板", Toast.LENGTH_SHORT).show();
    }
}