...
public class Q2M extends AppCompatActivity {
    private String QQ_Code, SecID;
    private EditText QQ_input, QQ_msg_output;
    private String mod = "q2m", lay = "json";
...
//                Toast.makeText(GetSecIDActivity.this, "SecID申请成功", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q2_m);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); // 返回箭头
        getSupportActionBar().setTitle("QQ查绑");
    ...
    private void initView() {
        QQ_input = findViewById(R.id.qq_code_input);
        QQ_msg_output = findViewById(R.id.qq_msg_output);
    }
...
//        Log.d(TAG, SecID);
    ...
    public void inquireQ2M(View view) {
        ...
        if(QQ_Code.length() == 0) {
            Toast.makeText(Q2M.this, "请输入QQ", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(Q2M.this, "查询中...", Toast.LENGTH_SHORT).show();
...
//            Log.d("tag" , "q2m" + uin);
    ...
    public void copyMsg(View view) {
        ...
        Toast.makeText(Q2M.this, "已复制到粘贴板", Toast.LENGTH_SHORT).show();
    }
